...
そして、その選んだ都市に関する、観光客が気になるような「質問」を一つ考えてください。ジャンルはグルメに絞ります。また、実際の観光客が質問しそうな言葉遣いにしてください。
※余計な挨拶や説明は一切不要です。文字列だけを出力してください。
例：「群馬県で最も美味しいイタリアンのお店はどこですか？」「静岡県沼津市の地元民が通う名店はどこですか？」「青森県の大間で安くマグロが食べれる店はありますか？」`;
